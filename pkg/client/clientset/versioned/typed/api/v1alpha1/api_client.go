...
type GatewayV1alpha1Interface interface {
	...
	GatewayExtensionPoliciesGetter
...
func (c *GatewayV1alpha1Client) GatewayExtensionPolicies(namespace string) GatewayExtensionPolicyInterface {
	return newGatewayExtensionPolicies(c, namespace)
}
