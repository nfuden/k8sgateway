...
func (c *FakeGatewayV1alpha1) GatewayExtensionPolicies(namespace string) v1alpha1.GatewayExtensionPolicyInterface {
	return newFakeGatewayExtensionPolicies(c, namespace)
}
