...
type GatewayExtensionSpecApplyConfiguration struct {
	Type    *apiv1alpha1.GatewayExtensionPolicyType `json:"type,omitempty"`
...
func (b *GatewayExtensionSpecApplyConfiguration) WithType(value apiv1alpha1.GatewayExtensionPolicyType) *GatewayExtensionSpecApplyConfiguration {
	b.Type = &value
	return b
}
