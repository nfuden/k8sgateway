...
func NewGatewayExtensionsCollection(
	...
	kubeclient.Register[*v1alpha1.GatewayExtension](
		...
		func(c kubeclient.ClientGetter, namespace string, o metav1.ListOptions) (runtime.Object, error) {
			return ourClient.GatewayV1alpha1().
				GatewayExtensions(namespace).
	...
	rawGwExts := krt.WrapClient(
		kclient.New[*v1alpha1.GatewayExtension](client),
		krtOpts.ToOptions("GatewayExtension")...)
	gwExtCol := krt.NewCollection(
		rawGwExts,
		func(krtctx krt.HandlerContext, cr *v1alpha1.GatewayExtension) *ir.GatewayExtension {
